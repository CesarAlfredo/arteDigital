...
<body>
  ...
  <tr>
	...
	<tr>
      <td>Conitos de dulce de leche</td>
	  <td>$99</td>
      <td><button class="button">+ AÑADIR</button></td>
    </tr>
    <tr>
...
<div class="container mx-auto flex">
        <div class="img_container ">
            <img src="/img/b0.jpg" alt="" class="main_img">
         </div>

        <div class="thumbnail_container">
            <img class="thumbnail active" src="/img/b1.jpg" alt="">
            <img class="thumbnail" src="img/b2.jpg" alt="">
            <img class="thumbnail" src="/img/b3.jpg" alt="">
            <img class="thumbnail" src="/img/b4.jpg" alt=""> 
